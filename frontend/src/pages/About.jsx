    ...
    <div>
      ...
      <div className='my-10 flex flex-col md:flex-row gap-12'>
        ...
        <div className='flex flex-col justify-center gap-6 md:w-2/4 text-sm text-gray-600'>
          <p>Welcome to Prescripto, Your Trusted Pertner In Managing Your Healthcare Needs Conveniently And Efficiently.
            At Prescripto ,We Understand The Challenges Individuls Face When It Comes To Scheduling 
            Doctor Appointment And Managing Their Health Records.
          </p>
          <p>Prescripto Is Committed To Excellence In Technology. We Continuously Strive To Enhance Our
